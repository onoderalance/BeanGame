...
if(obj_player.m_player_selectActive)
{
	...
	draw_sprite(global.beanList[|obj_player.m_player_selectID].sprite, 0, 
		TILE_SIZE*7 - (sprite_get_width(global.beanList[|obj_player.m_player_selectID].sprite)/2), 0);
	
	draw_set_halign(fa_center);
	draw_set_font(fnt_beanSmall);
	//currently center to grid tiles 6, 1, with 2 pixel offest on x axis
	draw_text_ext_color(TILE_SIZE*7, TILE_SIZE*1, global.beanList[|obj_player.m_player_selectID].name, 6, 30,
